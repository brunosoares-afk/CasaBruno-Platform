...
from app.routers.web_recognition import router as web_recognition_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origin_regex=r"^https?://(localhost|127\.0\.0\.1|192\.168\.(2|10)\.\d{1,3}|100\.\d{1,3}\.\d{1,3}\.\d{1,3}|742e077a94a9\.sn\.mynetname\.net)(:\d+)?$",
...
app.include_router(web_recognition_router)
