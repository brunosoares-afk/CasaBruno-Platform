# Vendored from the icsee_ptz HA custom_component (github.com/dbuezas/icsee-ptz),
# unchanged — the async DVR-IP/NetSurveillance/Sofia protocol client the iCSee
# camera actually speaks (not ONVIF). No HA-specific imports, safe to reuse standalone.
import os
import struct
import json
import hashlib
